...
(function ($, sfun, undefined) {
    ...
    var tests = function () {
        ...
        multi_test('check vistable refresh', function (arg) {
            return function () {
                resetTest(arg);
        ...
        multi_test('reres of first page of images', function (arg) {
            return function () {
                resetTest(arg);
                QUnit.stop();
        ...
        multi_test('rapid scroll event queuing', function (arg) {
            return function () {
        ...
        test('image click #1, return, down arrow next, home', function () {
