...
class ImageMetadata
{
     ...
     * @param object $in directory entry
     */
    ...
    /**
     * Select and rename a few of the generic entry fields for storing as image metadata
     * @param object $entry
     * @return object filtered and renamed metadata (this object)
     */
    public function ingestGenericEntry($entry)
    {
